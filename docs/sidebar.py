...
def generate_header(notebook_name: str) -> str:
    return f"""
<a href="https://colab.research.google.com/github/vanna-ai/vanna/blob/main/notebooks/{notebook_name}.ipynb" target="_blank" class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
...
<a href="https://github.com/vanna-ai/vanna/blob/main/notebooks/{notebook_name}.ipynb" target="_blank" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
